...
export function settingsScreen() {
  ...
  return h('div', { class: 'container container--narrow section stack' },
    ...
    h('div', { class: 'card' },
      ...
      selectRow('نمط الدرس الافتراضي', 'مختصر نحو ٥ دقائق، معتدل نحو ١٠، متعمّق لكل التفاصيل.', 'detail', [
        { value: 'brief', label: 'مختصر' },
        { value: 'standard', label: 'معتدل' },
        { value: 'deep', label: 'متعمّق' },
      ]),
      toggleRow('وضع أسري', 'يُظهر سؤال نقاش أسري في نهاية كل درس.', 'familyMode'),
