...
- **المرحلة 3 (منفّذة جزئيًا):** ٦ مستويات متدرّجة (تصنيف تربوي مركّب) + شاشة اختيار
  مستويات + حرية البدء من أي مستوى + حفظ تقدّم مستقل لكل مستوى + زر رجوع في الجلسة +
  شاشة نتيجة المحاولة الأولى ثم جلسة تصحيح الأخطاء (الدرجة تبقى للمحاولة الأولى). ✅
- **المرحلة 4:** حسابات ومزامنة سحابية اختيارية، ملفات صوت بشرية، مزيد من أنواع التمارين،
  PWA (عمل دون اتصال).
